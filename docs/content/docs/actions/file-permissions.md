...
- The `mode` field must be a **quoted string**. Unquoted `0755` is interpreted by YAML as the integer 493. See the [YAML Reference](../yaml-reference/#octal-numbers--always-quote-file-modes).
- Use [`file-ownership`](file-ownership/) to change file ownership.
