...
See also: [Actions Reference — `!include`](actions/README.md#include--file-inclusion)

### `!add` / `!remove`

Control how list fields merge across layers. Currently supported on the `groups` field of [`system-user`](actions/system-user.md).
...
Insert content at the end or beginning of an existing file. Used on the `content` field of [`file-edit`](actions/file-edit.md).
...
Insert content before or after lines matching a regex pattern. Used on the `content` field of [`file-edit`](actions/file-edit.md).
...
Remove content before or after a matching line. The matched line itself is always kept. Used on the `content` field of [`file-edit`](actions/file-edit.md).
...
See also: [systemd-service — `!replace` tag](actions/systemd-service.md#replace-tag)
