...
- The `name` must match a partition defined by an earlier [`partition-add`](partition-add/) step.
- Use [`partition-change`](partition-change/) to modify a partition's fields without removing it.
